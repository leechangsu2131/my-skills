...
if (btnCancel) {
    btnCancel.click(); // eXbuilder6 버튼 cancel 클릭
    return {success: true, msg: "btnCancel.click() executed"};
}
return {success: false, error: "btnCancel not found"};
"""

try:
    res = driver.execute_script(JS_CLOSE_CANCEL)
...
try:
    ...
    print("FINAL VERIFIED NEIS DATA:")
