...
async def main():
    ...
    # 진행 중인 4건 (Sn 748, 746, 745, 743) 회수
    print("  -> 진행 중인 4개 연수건 (Sn 748, 746, 745, 743) 통합 회수 실행...")
    js_recall_4 = """
    (function() {
        ...
        if (targetRows.length === 0) return {ok: true, recalledCount: 0, msg: "회수할 건이 없습니다"};
    ...
    """
    res = await page.evaluate(js_recall_4)
    print("  [OK] 4건 회수 버튼 클릭 결과:", res)
