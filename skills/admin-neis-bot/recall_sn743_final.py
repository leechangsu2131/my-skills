...
async def main():
    ...
    (function() {
        ...
        for (var i = 0; i < ds.getRowCount(); i++) {
            if (ds.getValue(i, "workSittnSn") === "743" && ds.getValue(i, "atrzStsCd") === "1") {
                targetRow = i;
                break;
            }
        }
        if (targetRow < 0) return {ok: true, msg: "743건이 이미 회수되었습니다"};
    ...
    """
    res = await page.evaluate(js_recall_743)
    print("  [OK] Sn 743 회수 클릭 결과:", res)
