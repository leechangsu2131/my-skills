...
async def main():
    ...
    (function() {
        ...
        for (var i = 0; i < ds.getRowCount(); i++) {
            if (ds.getValue(i, "workSittnSn") === "744") { targetRow = i; break; }
        }
        if (targetRow < 0) return {ok: true, msg: "744건이 이미 없습니다"};
    ...
    """
    res = await page.evaluate(js_recall_744)
    print("  [OK] Sn 744 회수 결과:", res)
