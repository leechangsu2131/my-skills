...
async function checkAll() {
    await new Promise(r => setTimeout(r, 3000)); // 조회 시간 대기
    ...
    for (var i=0; i<dateCount; i++) {
        ...
        await new Promise(r => setTimeout(r, 2000)); // 날짜 선택 조회 대기
        ...
        result.push({
            ...
            ymdNm: ymdNm,
            totalRows: count,
            records: rows.slice(0, 3) // 로그 가독성을 위해 상위 3명 샘플링
        });
    }
    return result;
}
...
return "Verification sequence started...";
"""

try:
    res = driver.execute_script(JS_VERIFY_FINAL)
    print("Verification started:", res)
...
print("FINAL SYSTEM STATUS DUMP:")
