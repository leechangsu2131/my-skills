...
Question-region layout extraction now uses a lightweight internal geometry layer (`ocr/question_layout.py`), so OCR anchor parsing, deduplication, and answer-box construction all run through one dependency-light layout pipeline.
